...
module OnlineCourse
  class SubjectsControllerTest < ActionDispatch::IntegrationTest
    ...
    setup do
      @subject = online_course_subjects(:one)
    end
    ...
    test "should create subject" do
      assert_difference('Subject.count') do
        post subjects_url, params: { subject: { area_id: @subject.area_id, name: @subject.name } }
      end
    ...
    test "should update subject" do
      patch subject_url(@subject), params: { subject: { area_id: @subject.area_id, name: @subject.name } }
